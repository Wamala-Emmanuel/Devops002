    ...
    public class CredentialService : ICredentialService
    {
        ...
        public async Task SchedulePasswordRenewalJobAsync(Guid requestId)
        {
            ...
            if (resultJson.PasswordDaysLeft <= niraSettings.CredentialConfig.PasswordDaysLimit)
            {
                ...
                _logger.LogInformation("The renew password job wil be scheduled to run after one minute.");
            }
            else
            {
                ...
                _logger.LogInformation("The renew password job wil be scheduled to run after {daysToRun} days.", timeSpanDelay.Days);
            }
